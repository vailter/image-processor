...
import com.vailter.image.codec.Base64;
import com.vailter.image.ex.ImageParseException;
import com.vailter.image.filter.CropCircleFilter;
import com.vailter.image.filter.CropFilter;
import com.vailter.image.filter.GradientFilter;
import com.vailter.image.filter.GrayscaleFilter;
import com.vailter.image.filter.PixellateFilter;
import com.vailter.image.filter.RotateFilter;
import com.vailter.image.filter.ScaleFilter;
import com.vailter.image.filter.SepiaToneFilter;
import com.vailter.image.filter.ThresholdFilter;
import com.vailter.image.filter.ZipFilter;
...
public class ImageKit {
	...
	public ImageKit rotate() {
		this.image = ImageKitUtils.rotate(this.image, 180);
	 ...
	 * @return
	 */
	public ImageKit rotate(int angle) {
		this.image = ImageKitUtils.rotate(this.image, angle);
		return this;
