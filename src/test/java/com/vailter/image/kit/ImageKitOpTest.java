...
public class ImageKitOpTest {
    ...
    static String pngPath = "C:\\Users\\vailt\\Desktop\\BUI-Template-1.4.73 (1)\\TIM截图20181018094026.png";

    ImageKit kit = null;

    @Before
    public void readImage() throws URISyntaxException {
        //File file = new File(ImageKitOpTest.class.getResource(pngPath).toURI());
    ...
    @Test
    public void rotate2() {
        System.out.println(kit.getFormat());
        kit.rotate(270).transferTo("d:/rotate90." + kit.getFormat());
    }
